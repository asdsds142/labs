...
/*todo: проставить везде чтоб ровненько было по 2 строки было между функциями и может еще чего косметически
приделать к матрицам работу с массивами и возможно запись, доставание массива матриц в файл*/
