...
void ignore_much(istream& input_stream)
{
...
void try_input(istream& input_stream, string& buffer, string msg)
{
    cout << msg;
    cout.flush();
...
void try_getline(istream& input_stream, string& buffer, string msg)
{
    cout << msg;
    cout.flush();
...
void try_input(istream& input_stream, long& buffer, string msg)
{
    cout << msg;
    cout.flush();
    ...
    while (i)
    {
        try_input(input_stream, str_buffer);
        try
        {
