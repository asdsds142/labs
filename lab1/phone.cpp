...
Phone::Phone(string surname, string name, string father_name, string adress, long number, long incity_t, long intercity_t) : 
surname_(surname), name_(name), father_name_(father_name), adress_(adress), number_(number), incity_time_(incity_t), intercity_time_(intercity_t) {}
...
void Phone::show()
{
    cout << "Имя: " << this->surname_ << " " << this->name_ << " " << this->father_name_ << endl;
...
void Phone::to_file(ofstream& file_stream)
{
    ...
    file_stream << surname_ << endl << name_ << endl << father_name_ << endl << adress_ << endl << number_ << endl << incity_time_ << endl << intercity_time_ << endl;
